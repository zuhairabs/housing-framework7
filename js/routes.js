var routes = [
  ...
  // booknow page
    {
        path: '/booknow/',
        url: './pages/booknow.html',
        name: 'booknow',
  },
  // buynow page
    {
        path: '/buynow/',
        url: './pages/buynow.html',
        name: 'buynow',
  },
  // confirm page
    {
  ...
  // Nearby page
    {
        path: '/nearby/',
        url: './pages/nearby.html',
        name: 'nearby',
  },
  // nearbylist page
    {
        path: '/nearbylist/',
        url: './pages/nearbylist.html',
        name: 'nearbylist',
  },
  // new offer page
    {
        path: '/newoffer/',
        url: './pages/newoffer.html',
        name: 'newoffer',
  },
  // payment page
    {
  ...
  // propertydetails page
    {
        ...
        url: './pages/propertydetails.html',
  ...
  // controls page
    {
        path: '/control/',
        url: './pages/control.html',
        name: 'control',
  },



//-- Default pages frameworks start here ---//    
// Right Panel pages
    {
        path: '/panel-right-1/',
        content: '\
